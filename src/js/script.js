...
async function loadPortfolio() {
    try {
        ...
        if (data.hero) {
            ...
            document.getElementById('cvButton').onclick = () => {
                if (data.hero.cvLink) window.open(data.hero.cvLink, '_blank');
            };
        }
        ...
        if (data.projects?.length > count) {
            exploreBtn.innerHTML = `<a href="projects.html" class="btn-custom">Explore All Projects <i class="fas fa-arrow-right"></i></a>`;
        } else {
